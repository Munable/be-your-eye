...
표시만 하던 기기도 알림을 줄 수 있도록. 호환되는 여분의 휴대폰을 화면에 향하게 두고 숫자 조건을 설정하면, 눈에 보이는 변화를 이벤트로 남길 수 있습니다. 관찰하는 기기를 개조할 필요가 없습니다. 인식과 기록은 휴대폰 안에서 처리됩니다.

[제품의 출발점과 설계 선택 (영어·중국어 간체)](docs/PRODUCT_POSITIONING.md).
